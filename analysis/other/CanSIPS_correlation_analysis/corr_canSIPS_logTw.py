...
monthly_avg_Twater = np.log10(monthly_avg_Twater)
...
#         np.savez(p_dir+'corr'+str(p_critical)+'_CanSIPS_'+feature_list[feat]+'_ensm_'+ 'anom'*anomaly+ 'fcst'*(~anomaly) +'_'+'LongueuilTwlog10'+'_lead_'+str(lead)+'_'+str(years_cansips[iyr_start])+'_'+str(years_cansips[iyr_end]),
#                   rsqr=rsqr,
#                   corr=corr,
#                   signif=signif,
#                    data_corr = data_corr)
...
#     data_tmp = np.load(p_dir+'corr'+str(p_critical)+'_CanSIPS_'+feature_list[feat]+'_ensm_'+ 'anom'*anomaly+ 'fcst'*(~anomaly) +'_'+'LongueuilTwlog10'+'_lead_'+str(lead)+'_'+str(years_cansips[iyr_start])+'_'+str(years_cansips[iyr_end])+'.npz')
#     rsqr=data_tmp['rsqr']
...
plt.suptitle('Forecast of ' + feature_list[feat] + ' log10 in Dec. vs avg Dec. Tw Longueuil')
...
fig,ax = plt.subplots(nrows=2,ncols=2,figsize=(18,8),sharex=True,sharey=True,subplot_kw={'projection': ccrs.PlateCarree()})
plt.suptitle('Forecast of ' + feature_list[feat] + ' log10 in Nov. vs avg Dec. Tw Longueuil')
...
fig,ax = plt.subplots(nrows=2,ncols=2,figsize=(18,8),sharex=True,sharey=True,subplot_kw={'projection': ccrs.PlateCarree()})
plt.suptitle('Forecast of ' + feature_list[feat] + ' log10 in Oct. vs avg Dec. Tw Longueuil')
...
fig,ax = plt.subplots(nrows=2,ncols=2,figsize=(18,8),sharex=True,sharey=True,subplot_kw={'projection': ccrs.PlateCarree()})
plt.suptitle('Forecast of ' + feature_list[feat] + ' log10 in Sep. vs avg Dec. Tw Longueuil')
...
feat = 2
lead = 0
data_tmp = np.load(p_dir+'corr'+str(p_critical)+'_CanSIPS_'+feature_list[feat]+'_ensm_'+ 'anom' +'_'+'LongueuilTwlog10'+'_lead_'+str(lead)+'_'+str(years_cansips[iyr_start])+'_'+str(years_cansips[iyr_end])+'.npz')
rsqr=data_tmp['rsqr']
signif=data_tmp['signif']
corr=data_tmp['corr']
data_corr = data_tmp['data_corr']
...
ax.grid()
ax.set_xlabel('Year')
ax.set_ylabel('Avg Dec. Tw log10 Anomaly (deg. C)',color='black')
