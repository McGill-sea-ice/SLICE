...
from functions_MLR import freezeup_multiple_linear_regression_model,find_models_MLR
...
#%%
# FIND ALL COMBINATION OF PREDICTORS
...
if save_combinations:
    np.savez(fsave+'all_combinations',
              columns = a_list,
...
# npred = 2
# combinations = all_combinations_2
# find_models_MLR(npred,combinations,df,columns,avg_freezeup_doy,training_size,nyears,rolling_training,rlim,ralim,fsave,anomaly,station_labels,freezeup_opt,deseasonalize,detrend)

# npred = 3
# combinations = all_combinations_3
# find_models_MLR(npred,combinations,df,columns,avg_freezeup_doy,training_size,nyears,rolling_training,rlim,ralim,fsave,anomaly,station_labels,freezeup_opt,deseasonalize,detrend)

# npred = 4
# combinations = all_combinations_4
# find_models_MLR(npred,combinations,df,columns,avg_freezeup_doy,training_size,nyears,rolling_training,rlim,ralim,fsave,anomaly,station_labels,freezeup_opt,deseasonalize,detrend)

# npred = 5
# combinations = all_combinations_5
# find_models_MLR(npred,combinations,df,columns,avg_freezeup_doy,training_size,nyears,rolling_training,rlim,ralim,fsave,anomaly,station_labels,freezeup_opt,deseasonalize,detrend)

#%%
x_model = ['Sept. RH Anomaly','Nov. precip Anomaly','Nov. NAO Anomaly']
...
#%%
x_model = ['Sept. RH Anomaly','Nov. precip Anomaly','Nov. NAO (daily) Anomaly']
[model_h,xall,yall,xf,yf_true,yf,xh_plot,xh,yh,
mae_h,rmse_h,Rsqr_h,Rsqr_adj_h,std_h,
mae_f,rmse_f,Rsqr_f,Rsqr_adj_f, std_f]  = freezeup_multiple_linear_regression_model(df[['Year','Freeze-up','Freeze-up Anomaly']+x_model],x_model,nyears,training_size,anomaly = anomaly,rolling_training=rolling_training,verbose=False)

#%%
x_model = ['Oct. windspeed Anomaly','Nov. precip Anomaly','Nov. level Anomaly','Nov. NAO Anomaly']
[model_h,xall,yall,xf,yf_true,yf,xh_plot,xh,yh,
mae_h,rmse_h,Rsqr_h,Rsqr_adj_h,std_h,
mae_f,rmse_f,Rsqr_f,Rsqr_adj_f, std_f]  = freezeup_multiple_linear_regression_model(df[['Year','Freeze-up','Freeze-up Anomaly']+x_model],x_model,nyears,training_size,anomaly = anomaly,rolling_training=rolling_training,verbose=False)

#%%
x_model = ['Oct. windspeed Anomaly','Nov. precip Anomaly','Nov. level Anomaly','Nov. NAO (daily) Anomaly']
[model_h,xall,yall,xf,yf_true,yf,xh_plot,xh,yh,
mae_h,rmse_h,Rsqr_h,Rsqr_adj_h,std_h,
mae_f,rmse_f,Rsqr_f,Rsqr_adj_f, std_f]  = freezeup_multiple_linear_regression_model(df[['Year','Freeze-up','Freeze-up Anomaly']+x_model],x_model,nyears,training_size,anomaly = anomaly,rolling_training=rolling_training,verbose=False)
