...
nvars = PDO_vars_all.shape[0]
nyears = PDO_vars_all.shape[1]
nwindows = PDO_vars_all.shape[2]
nend = PDO_vars_all.shape[3]
nwindowtype = PDO_vars_all.shape[4]
nlocs = PDO_vars_all.shape[5]
        ...
        for iw in range(nwindows):
            for iend in range(nend):
                for ip in range(nwindowtype):
                    for iloc in range(nlocs):
                        xvar = PDO_vars_all[ivar,:,iw,iend,ip,iloc]
                        yvar = avg_freezeup_doy

                        PDO_vars_all_detrended[ivar,:,iw,iend,ip,iloc], avg_freezeup_doy_detrended = detrend_ts(xvar,yvar,years,anomaly)
else:
...
for ivar in range(nvars):
    for iw in range(nwindows):
        for iend in range(nend):
            for ip in range(nwindowtype):
                for iloc in range(nlocs):
                    xvar = PDO_vars_all_detrended[ivar,:,iw,iend,ip,iloc]
...
#     locnames='Montreal'
#     multilocs_rollingcorr_correlation_plot(window_arr,np.expand_dims(np.expand_dims(PDO_vars_all[:,:,iend,:,:],axis=-1),axis=0),yvar,boot_iyears_all[:,iend,:].astype('int'),PDO_varnames,locnames,p_critical,detrend,anomaly,enddate_str)
...
PDO_monthly = PDO_vars_all_detrended[0,:,:,iend,ip,0]
# PDO_monthly = PDO_min_vars_all[0,:,:,iend,ip,0]

# plt.figure();plt.plot(years,PDO_monthly[:,7]);plt.title('Avg. PDO in January')
# plt.figure();plt.plot(years,PDO_monthly[:,6]);plt.title('Avg. PDO in February')
# plt.figure();plt.plot(years,PDO_monthly[:,5]);plt.title('Avg. PDO in March')
# plt.figure();plt.plot(years,PDO_monthly[:,4]);plt.title('Avg. PDO in April')
# plt.figure();plt.plot(years,PDO_monthly[:,3]);plt.title('Avg. PDO in May')
# plt.figure();plt.plot(years,PDO_monthly[:,2]);plt.title('Avg. PDO in June')
# plt.figure();plt.plot(years,PDO_monthly[:,1]);plt.title('Avg. PDO in July')
# plt.figure();plt.plot(years,PDO_monthly[:,0]);plt.title('Avg. PDO in August')
...
ax2.set_ylabel('Avg. PDO anomaly in Feb.', color= plt.get_cmap('tab10')(1))
...
ax2.set_ylabel('Avg. PDO anomaly in Jan.', color= plt.get_cmap('tab10')(1))
...
ax2.set_ylabel('PDO Jan. + PDO Feb.', color= plt.get_cmap('tab10')(1))
...
#%%
fig, ax = plt.subplots()
ax.plot(x,y,'o', color= plt.get_cmap('tab10')(0))

fig, ax = plt.subplots()
ax.plot(x,avg_freezeup_doy_detrended,'o', color= plt.get_cmap('tab10')(0))

fig, ax = plt.subplots()
ax.plot(y,avg_freezeup_doy_detrended,'o', color= plt.get_cmap('tab10')(0))
...
# ax2=ax.twinx()
# ax2.plot(years,x,'o--', color= plt.get_cmap('tab10')(1))
# ax2.set_ylabel('Avg. PDO anomaly in Aug.', color= plt.get_cmap('tab10')(1))
# lincoeff, Rsqr = linear_fit(x,avg_freezeup_doy_detrended)
# r =np.sqrt(Rsqr)
# if lincoeff[0]<0: r*=-1
# ax.text(2016,21,'r = %3.2f'%(r))
...
# ax2=ax.twinx()
# ax2.plot(years,x+y,'o--', color= plt.get_cmap('tab10')(1))
# ax2.set_ylabel('PDO Aug. + PDO Sept.', color= plt.get_cmap('tab10')(1))
# lincoeff, Rsqr = linear_fit(x+y,avg_freezeup_doy_detrended)
# r =np.sqrt(Rsqr)
# if lincoeff[0]<0: r*=-1
# ax.text(2016,21,'r = %3.2f'%(r))
...
# ax.set_xlabel('Year')
# ax.set_ylabel('PDO Sept.', color= plt.get_cmap('tab10')(0))
# ax.grid()
# ax2=ax.twinx()
# ax2.plot(years,x,'o--', color= plt.get_cmap('tab10')(1))
# ax2.set_ylabel('PDO Aug.', color= plt.get_cmap('tab10')(1))
# lincoeff, Rsqr = linear_fit(x,y)
# r =np.sqrt(Rsqr)
# if lincoeff[0]<0: r*=-1
# ax.text(2016,1,'r = %3.2f'%(r))
# #%%
# PDO_monthly = PDO_vars_all_detrended[0,:,:,0,ip,0]
# x = PDO_monthly[:,-1]
# fig, ax = plt.subplots()
# ax.plot(years,avg_freezeup_doy_detrended,'o-', color= plt.get_cmap('tab10')(0))
# ax.set_xlabel('Year')
...
# ax2=ax.twinx()
# ax2.plot(years,x,'o--', color= plt.get_cmap('tab10')(1))
# ax2.set_ylabel('Avg. PDO anomaly in April', color= plt.get_cmap('tab10')(1))
# lincoeff, Rsqr = linear_fit(x,avg_freezeup_doy_detrended)
# r =np.sqrt(Rsqr)
# if lincoeff[0]<0: r*=-1
# ax.text(2016,21,'r = %3.2f'%(r))
...
# ax2=ax.twinx()
# ax2.plot(years,-x+y,'o--', color= plt.get_cmap('tab10')(1))
# ax2.set_ylabel('- PDO Aug.- PDO Sept. + PDO April', color= plt.get_cmap('tab10')(1))
# lincoeff, Rsqr = linear_fit(-x+y,avg_freezeup_doy_detrended)
# r =np.sqrt(Rsqr)
# if lincoeff[0]<0: r*=-1
# ax.text(2016,21,'r = %3.2f'%(r))
...
# plt.xlabel('Avg. PDO anomaly in Sept.')
# plt.ylabel('Freezeup Anomaly')

# plt.figure()
# plt.plot(y,avg_freezeup_doy_detrended,'o')
# plt.xlabel('Avg. PDO anomaly in Nov.')
# plt.ylabel('Freezeup Anomaly')

# plt.figure()
# plt.plot(x,y,'o')
# plt.xlabel('Avg. PDO anomaly in Sept.')
# plt.ylabel('Avg. PDO anomaly in Nov.')
...
# plt.figure()
# plt.plot(y,avg_freezeup_doy_detrended,'o')
# plt.xlabel('Avg. PDO anomaly in Aug.')
# plt.ylabel('Freezeup Anomaly')

# plt.figure()
# plt.plot(x,y,'o')
# plt.xlabel('Avg. PDO anomaly in Sept.')
# plt.ylabel('Avg. PDO anomaly in Aug.')
