...
# LOAD ERA5 DATA WITH NOV. 2021 TO MAKE PREDICTION
region = 'D'
weather_path = '/Volumes/SeagateUSB/McGill/Postdoc/slice/data/processed/ERA5/region'+region+'/'
ERA5_vars_all = np.load(weather_path+'weather_vars_ERA5.npz')['weather_vars']
ERA5_vars_all = ERA5_vars_all[:,:,:,:,0,0]
...
ERA5_vars_all = ERA5_vars_all[:,iy_start:iy_end,:,:]
...
if detrend:
    ...
    ERA5_vars_all_detrended = np.zeros(ERA5_vars_all.shape)*np.nan
    ...
    for ivar in range(nvars):
        for iw in range(nwindows):
            for iend in range(nend):
                ...
                wvar = ERA5_vars_all[ivar,:,iw,iend]

                vars_all_detrended[ivar,:,iw,iend]= detrend_ts(xvar,years,anomaly)
                ERA5_vars_all_detrended[ivar,:,iw,iend]= detrend_ts(wvar,years,anomaly)
    ...
    ERA5_vars_all_detrended = ERA5_vars_all.copy()
...
ERA5_monthly = np.zeros((nvars,nyears,11))
...
for ivar in range(nvars):
    ...
    ERA5_monthly[ivar,:,3:]= np.fliplr(ERA5_vars_all_detrended[ivar,:,:,0])
    ERA5_monthly[ivar,:,0:3]= np.fliplr(ERA5_vars_all_detrended[ivar,:,5:8,-1])
...
Nov2021_snow = ERA5_monthly[11,-1,10]
Nov2021_Ta_mean = ERA5_monthly[2,-1,10]
Nov2021_Ta_min = ERA5_monthly[1,-1,10]
Nov2021_Ta_max = ERA5_monthly[0,-1,10]
Nov2021_SLP = ERA5_monthly[7,-1,10]
Nov2021_TDD = ERA5_monthly[3,-1,10]
Nov2021_FDD = ERA5_monthly[4,-1,10]
Nov2021_RH = ERA5_monthly[14,-1,10]
Nov2021_clouds = ERA5_monthly[12,-1,10]
Nov2021_precip = ERA5_monthly[6,-1,10]

# Nov_discharge = QL_monthly[0,:,10]
Nov2021_level = QL_monthly[1,-1,10]
# Nov_NAO = NAO_monthly[:,10]
Nov2021_NAO_daily = NAO_daily_monthly[-1,10]
...
#%%
#PREDICTIONS INCLUDING NOV. VARIABLES - 3 predictors
...
# GREEN
x_model = ['Apr. Snowfall Anomaly','Sept. SLP Anomaly','Nov. NAO (daily) Anomaly']
...
# SICK GREEN
x_model = ['May Ta_avg Anomaly','Nov. precip Anomaly','Nov. level Anomaly']
[model,xall,yall,xf,yf_true,yf,xh_plot,xh,yh,
mae_h,rmse_h,Rsqr_h,Rsqr_adj_h,std_h,
mae_f,rmse_f,Rsqr_f,Rsqr_adj_f, std_f] = freezeup_multiple_linear_regression_model(df[['Year','Freeze-up','Freeze-up Anomaly']+x_model],x_model,nyears,training_size,anomaly = anomaly,rolling_training=rolling_training)
ax.plot(xall,yall,'o-',color='k')
...
print('SICK GREEN - 2021 prediction:  ')


# PURPLE
x_model = ['Sept. Cloud Anomaly','Nov. precip Anomaly','Nov. NAO (daily) Anomaly']
[model,xall,yall,xf,yf_true,yf,xh_plot,xh,yh,
mae_h,rmse_h,Rsqr_h,Rsqr_adj_h,std_h,
mae_f,rmse_f,Rsqr_f,Rsqr_adj_f, std_f] = freezeup_multiple_linear_regression_model(df[['Year','Freeze-up','Freeze-up Anomaly']+x_model],x_model,nyears,training_size,anomaly = anomaly,rolling_training=rolling_training)
ax.plot(xall,yall,'o-',color='k')
...
print('PURPLE - 2021 prediction:  ')


# PINK
x_model = ['Sept. Snowfall Anomaly','Nov. precip Anomaly','Nov. level Anomaly']
[model,xall,yall,xf,yf_true,yf,xh_plot,xh,yh,
mae_h,rmse_h,Rsqr_h,Rsqr_adj_h,std_h,
mae_f,rmse_f,Rsqr_f,Rsqr_adj_f, std_f] = freezeup_multiple_linear_regression_model(df[['Year','Freeze-up','Freeze-up Anomaly']+x_model],x_model,nyears,training_size,anomaly = anomaly,rolling_training=rolling_training)
ax.plot(xall,yall,'o-',color='k')
...
print('PinK - 2021 prediction:  ')


# BROWN ****************************
x_model = ['Oct. windspeed Anomaly','Nov. precip Anomaly','Nov. level Anomaly']
[model,xall,yall,xf,yf_true,yf,xh_plot,xh,yh,
mae_h,rmse_h,Rsqr_h,Rsqr_adj_h,std_h,
mae_f,rmse_f,Rsqr_f,Rsqr_adj_f, std_f] = freezeup_multiple_linear_regression_model(df[['Year','Freeze-up','Freeze-up Anomaly']+x_model],x_model,nyears,training_size,anomaly = anomaly,rolling_training=rolling_training)
ax.plot(xall,yall,'o-',color='k')
...
# BLUE ****************************
x_model = ['Oct. level Anomaly','Nov. aTDD Anomaly','Nov. precip Anomaly']
[model,xall,yall,xf,yf_true,yf,xh_plot,xh,yh,
mae_h,rmse_h,Rsqr_h,Rsqr_adj_h,std_h,
mae_f,rmse_f,Rsqr_f,Rsqr_adj_f, std_f] = freezeup_multiple_linear_regression_model(df[['Year','Freeze-up','Freeze-up Anomaly']+x_model],x_model,nyears,training_size,anomaly = anomaly,rolling_training=rolling_training)
ax.plot(xall,yall,'o-',color='k')
...
print('BLUE - 2021 prediction:  ')


#%%
# PREDICTIONS INCLUDING NOV. VARIABLES - 4 predictors
...
x_model = ['Jan. PDO Anomaly','Oct. windspeed Anomaly','Nov. precip Anomaly','Nov. level Anomaly']
[model,xall,yall,xf,yf_true,yf,xh_plot,xh,yh,
mae_h,rmse_h,Rsqr_h,Rsqr_adj_h,std_h,
mae_f,rmse_f,Rsqr_f,Rsqr_adj_f, std_f] = freezeup_multiple_linear_regression_model(df[['Year','Freeze-up','Freeze-up Anomaly']+x_model],x_model,nyears,training_size,anomaly = anomaly,rolling_training=rolling_training)
ax.plot(xall,yall,'o-',color='k')
...
# ***** 2 BLUE ****************************
x_model = ['Sept. Snowfall Anomaly','Nov. Ta_avg Anomaly','Nov. precip Anomaly','Nov. level Anomaly']
[model,xall,yall,xf,yf_true,yf,xh_plot,xh,yh,
mae_h,rmse_h,Rsqr_h,Rsqr_adj_h,std_h,
mae_f,rmse_f,Rsqr_f,Rsqr_adj_f, std_f] = freezeup_multiple_linear_regression_model(df[['Year','Freeze-up','Freeze-up Anomaly']+x_model],x_model,nyears,training_size,anomaly = anomaly,rolling_training=rolling_training)
ax.plot(xall,yall,'o-',color='k')
...
# 2 BROWN ****************************
x_model = ['Sept. Snowfall Anomaly','Nov. aTDD Anomaly','Nov. precip Anomaly','Nov. level Anomaly']
[model,xall,yall,xf,yf_true,yf,xh_plot,xh,yh,
mae_h,rmse_h,Rsqr_h,Rsqr_adj_h,std_h,
mae_f,rmse_f,Rsqr_f,Rsqr_adj_f, std_f] = freezeup_multiple_linear_regression_model(df[['Year','Freeze-up','Freeze-up Anomaly']+x_model],x_model,nyears,training_size,anomaly = anomaly,rolling_training=rolling_training)
ax.plot(xall,yall,'o-',color='k')
