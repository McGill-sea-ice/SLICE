...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 25 10:52:46 2021
...
models = model_data['models_'+str(npred)]

# NEW RESAVED DATA
model_dataTEST = np.load(fpathTEST+'models'+str(npred)+'_ts'+str(training_size)+'.npz',allow_pickle=True)
x_modelsTEST = model_dataTEST['x_models']
yh_true_modelsTEST = model_dataTEST['yh_true_models']
yh_modelsTEST = model_dataTEST['yh_models']
xh_modelsTEST = model_dataTEST['xh_models']
modelsTEST = model_dataTEST['models_h']
...
xmodels_startdate = models_startdate['models_'+str(npred)+'_'+start_date]

x_models_startdate = model_data['x_models_'+str(npred)][imodels]
mae_f_models_startdate = model_data['mae_f_models_'+str(npred)][imodels]
rmse_f_models_startdate = model_data['rmse_f_models_'+str(npred)][imodels]
Rsqr_f_models_startdate = model_data['Rsqr_f_models_'+str(npred)][imodels]
Rsqr_adj_f_models_startdate = model_data['Rsqr_adj_f_models_'+str(npred)][imodels]
std_f_models_startdate = model_data['std_f_models_'+str(npred)][imodels]
mae_h_models_startdate = model_data['mae_h_models_'+str(npred)][imodels]
rmse_h_models_startdate = model_data['rmse_h_models_'+str(npred)][imodels]
Rsqr_h_models_startdate =  model_data['Rsqr_h_models_'+str(npred)][imodels]
Rsqr_adj_h_models_startdate = model_data['Rsqr_adj_h_models_'+str(npred)][imodels]
std_h_models_startdate = model_data['std_h_models_'+str(npred)][imodels]
xf_models_startdate = model_data['xf_models_'+str(npred)][imodels]
yf_models_startdate = model_data['yf_models_'+str(npred)][imodels]
xh_models_startdate = model_data['xh_models_'+str(npred)][imodels]
yh_models_startdate = model_data['yh_models_'+str(npred)][imodels]


# NEW DATA RESAVED
start_date = 'Nov1'
models_startdateTEST = np.load(fpathTEST+'models'+str(npred)+'_ts'+str(training_size)+'_'+start_date+'.npz',allow_pickle=True)

x_models_startdateTEST = models_startdateTEST['x_models']
mae_f_models_startdateTEST = models_startdateTEST['mae_f_models']
rmse_f_models_startdateTEST = models_startdateTEST['rmse_f_models']
Rsqr_f_models_startdateTEST = models_startdateTEST['Rsqr_f_models']
Rsqr_adj_f_models_startdateTEST = models_startdateTEST['Rsqr_adj_f_models']
std_f_models_startdateTEST = models_startdateTEST['std_f_models']
mae_h_models_startdateTEST = models_startdateTEST['mae_h_models']
rmse_h_models_startdateTEST = models_startdateTEST['rmse_h_models']
Rsqr_h_models_startdateTEST =  models_startdateTEST['Rsqr_h_models']
Rsqr_adj_h_models_startdateTEST = models_startdateTEST['Rsqr_adj_h_models']
std_h_models_startdateTEST = models_startdateTEST['std_h_models']
xf_models_startdateTEST = models_startdateTEST['xf_models']
yf_models_startdateTEST = models_startdateTEST['yf_models']
xh_models_startdateTEST = models_startdateTEST['xh_models']
yh_models_startdateTEST = models_startdateTEST['yh_models']
...
#         # print([models_h[im].f_pvalue for im in range(len(models_h))])
#         # print(np.nanmean([models_h[im].f_pvalue for im in range(len(models_h))]))
#         # test.pvalues
