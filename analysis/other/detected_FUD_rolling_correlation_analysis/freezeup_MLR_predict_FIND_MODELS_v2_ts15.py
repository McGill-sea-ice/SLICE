...
#%%
a_list = np.arange(len(columns[3:]))
rlim = 0.2
ralim = 0.1
...
for r in range(2,3):
    ...
    all_combinations_2 += combinations_list

all_combinations_3 = []
for r in range(3,4):
    combinations_object = itertools.combinations(a_list, r)
    combinations_list = list(combinations_object)
    all_combinations_3 += combinations_list

all_combinations_4 = []
for r in range(4,5):
    combinations_object = itertools.combinations(a_list, r)
    combinations_list = list(combinations_object)
    all_combinations_4 += combinations_list

all_combinations_5 = []
for r in range(5,6):
    combinations_object = itertools.combinations(a_list, r)
    combinations_list = list(combinations_object)
    all_combinations_5 += combinations_list

# np.savez('./MLR_save_v2/all_combinations',
#           columns = a_list,
#           all_combinations_2 = all_combinations_2,
#           all_combinations_3 = all_combinations_3,
#           all_combinations_4 = all_combinations_4,
#           all_combinations_5 = all_combinations_5
#           )
...
for i in range(len(columns[3:])):
    # print(str(i)+'/'+str(len(all_combinations_2)))
    x_model = [ columns[3:][i] ]
    ...
    if (Rsqr_f >= rlim) & (Rsqr_adj_f >= ralim):
        models_1 += [model]
        x_models_1 += [x_model]
        mae_f_models_1 += [mae_f]
        rmse_f_models_1 += [rmse_f]
        Rsqr_f_models_1 += [Rsqr_f]
        Rsqr_adj_f_models_1 += [Rsqr_adj_f]
        std_f_models_1 += [std_f]
        mae_h_models_1 += [mae_h]
        rmse_h_models_1 += [rmse_h]
        Rsqr_h_models_1 += [Rsqr_h]
        Rsqr_adj_h_models_1 += [Rsqr_adj_h]
        std_h_models_1 += [std_h]
        xf_models_1 += [xf]
        yf_models_1 += [yf]
        xh_models_1 += [xh]
        xh_plot_models_1 += [xh_plot]
        yh_models_1 += [yh]


np.savez('./MLR_save_v2/models1_ts'+str(training_size),
            models_1 = models_1,
            x_models_1 = x_models_1,
            mae_f_models_1 = mae_f_models_1,
            rmse_f_models_1 = rmse_f_models_1,
            Rsqr_f_models_1 = Rsqr_f_models_1,
            Rsqr_adj_f_models_1 = Rsqr_adj_f_models_1,
            std_f_models_1 = std_f_models_1,
            mae_h_models_1 = mae_h_models_1,
            rmse_h_models_1 = rmse_h_models_1,
            Rsqr_h_models_1 =  Rsqr_h_models_1,
            Rsqr_adj_h_models_1 = Rsqr_adj_h_models_1,
            std_h_models_1 = std_h_models_1,
            xf_models_1 = xf_models_1,
            yf_models_1 = yf_models_1,
            xh_models_1 = xh_models_1,
            xh_plot_models_1 = xh_plot_models_1,
            yh_models_1 = yh_models_1,
...
# ax.plot(xf_models_1[im],yf_models_1[im], 'o:', color= plt.get_cmap('tab20')(4))
# ax.plot(np.squeeze(xh_plot_models_1[im])[0],yh_models_1[im][0], '-', color= plt.get_cmap('tab20')(5))
...
for i in range(len(all_combinations_2)):
    # print(str(i)+'/'+str(len(all_combinations_2)))
    x_model = [ columns[3:][c] for c in all_combinations_2[i] ]
    [model,xall,yall,xf,yf_true,yf,xh_plot,xh,yh,
    mae_h,rmse_h,Rsqr_h,Rsqr_adj_h,std_h,
    mae_f,rmse_f,Rsqr_f,Rsqr_adj_f, std_f] = freezeup_multiple_linear_regression_model(df[['Year','Freeze-up','Freeze-up Anomaly']+x_model],x_model,nyears,training_size,anomaly = anomaly,rolling_training=rolling_training,verbose=False)
    ...
    if (Rsqr_f >= rlim) & (Rsqr_adj_f >= ralim):
        models_2 += [model]
        x_models_2 += [x_model]
        mae_f_models_2 += [mae_f]
        rmse_f_models_2 += [rmse_f]
        Rsqr_f_models_2 += [Rsqr_f]
        Rsqr_adj_f_models_2 += [Rsqr_adj_f]
        std_f_models_2 += [std_f]
        mae_h_models_2 += [mae_h]
        rmse_h_models_2 += [rmse_h]
        Rsqr_h_models_2 += [Rsqr_h]
        Rsqr_adj_h_models_2 += [Rsqr_adj_h]
        std_h_models_2 += [std_h]
        xf_models_2 += [xf]
        yf_models_2 += [yf]
        xh_models_2 += [xh]
        xh_plot_models_2 += [xh_plot]
        yh_models_2 += [yh]

    if (i/(round(len(all_combinations_2)/10)*10))%(0.1) == 0:
        print(str(i)+'/'+str(len(all_combinations_2)))
        np.savez('./MLR_save_v2/models2_it'+str(i)+'_ts'+str(training_size),
                    models_2 = models_2,
                    x_models_2 = x_models_2,
                    mae_f_models_2 = mae_f_models_2,
                    rmse_f_models_2 = rmse_f_models_2,
                    Rsqr_f_models_2 = Rsqr_f_models_2,
                    Rsqr_adj_f_models_2 = Rsqr_adj_f_models_2,
                    std_f_models_2 = std_f_models_2,
                    mae_h_models_2 = mae_h_models_2,
                    rmse_h_models_2 = rmse_h_models_2,
                    Rsqr_h_models_2 =  Rsqr_h_models_2,
                    Rsqr_adj_h_models_2 = Rsqr_adj_h_models_2,
                    std_h_models_2 = std_h_models_2,
                    xf_models_2 = xf_models_2,
                    yf_models_2 = yf_models_2,
                    xh_models_2 = xh_models_2,
                    xh_plot_models_2 = xh_plot_models_2,
                    yh_models_2 = yh_models_2,
                    deseasonalize = deseasonalize ,
                    detrend = detrend,
                    station_labels = station_labels,
                    freezeup_opt = freezeup_opt,
...
yh_true_models_2 = []
for h in range(yh_models_2[0].shape[0]):
    yh_true_models_2 += [avg_freezeup_doy[h:h+training_size]]

Rsqr_pred_h_models_2 = []
for im in range(len(x_models_2)):
    r_tmp = np.zeros(yh_models_2[0].shape[0])*np.nan
    for h in range(yh_models_2[0].shape[0]):
        r_tmp[h] = predicted_r2(yh_true_models_2[h],np.squeeze(yh_models_2[im][h,:]),np.squeeze(xh_models_2[im][h,:]))
    Rsqr_pred_h_models_2 += [r_tmp]


np.savez('./MLR_save_v2/models2_ts'+str(training_size),
            models_2 = models_2,
            x_models_2 = x_models_2,
            mae_f_models_2 = mae_f_models_2,
            rmse_f_models_2 = rmse_f_models_2,
            ...
            Rsqr_h_models_2 =  Rsqr_h_models_2,
            Rsqr_adj_h_models_2 = Rsqr_adj_h_models_2,
            Rsqr_pred_h_models_2 = Rsqr_pred_h_models_2,
            std_h_models_2 = std_h_models_2,
            xf_models_2 = xf_models_2,
            yf_models_2 = yf_models_2,
            xh_models_2 = xh_models_2,
            xh_plot_models_2 = xh_plot_models_2,
            yh_models_2 = yh_models_2,
            yh_true_models_2 = yh_true_models_2,
            deseasonalize = deseasonalize ,
            detrend = detrend,
            station_labels = station_labels,
            freezeup_opt = freezeup_opt,
...
models_2_Nov1 = []
imodels_2_Nov1 = []
for i in range(len(x_models_2)):
    if (~np.any(['Nov' in x_models_2[i][0],'Nov' in x_models_2[i][1]])) & (~np.any(['Fall' in x_models_2[i][0],'Fall' in x_models_2[i][1]])) & (~np.any(['Apr. aFDD' in x_models_2[i][0],'Apr. aFDD' in x_models_2[i][1]])):
        x_tmp = np.squeeze(yall[training_size+1:])
        y_tmp = np.squeeze(yf_models_2[i][:])
        coeff,_ = linear_fit(x_tmp,y_tmp)
        if coeff[0] > 0 :
            models_2_Nov1 += [x_models_2[i]]
            imodels_2_Nov1 += [i]
            print(i,x_models_2[i])

models_2_Dec1 = []
imodels_2_Dec1 = []
for i in range(len(x_models_2)):
    if (~np.any(['Apr. aFDD' in x_models_2[i][0],'Apr. aFDD' in x_models_2[i][1]])):
        x_tmp = np.squeeze(yall[training_size+1:])
        y_tmp = np.squeeze(yf_models_2[i][:])
        coeff,_ = linear_fit(x_tmp,y_tmp)
        if coeff[0] > 0 :
            models_2_Dec1 += [x_models_2[i]]
            imodels_2_Dec1 += [i]
            print(i,x_models_2[i])

np.savez('./MLR_save_v2/models2_Nov1_ts'+str(training_size),
            models_2_Nov1 = models_2_Nov1,
            imodels_2_Nov1 = imodels_2_Nov1,
            rlim = rlim,
            ralim = ralim,)
np.savez('./MLR_save_v2/models2_Dec1_ts'+str(training_size),
                models_2_Dec1 = models_2_Dec1,
                imodels_2_Dec1 = imodels_2_Dec1,
                rlim = rlim,
                ralim = ralim,)
...
# im = 5458
# ax.plot(xall,yall,'o-',color='k')
# ax.plot(xf_models_5[im],yf_models_5[im], 'o:', color= plt.get_cmap('tab20')(4))
# ax.plot(np.squeeze(xh_plot_models_5[im])[0],yh_models_5[im][0], '-', color= plt.get_cmap('tab20')(5))
...
# for i,im in enumerate(imodels_2_Dec1):
#     if np.all(Rsqr_pred_h_models_2[im]>0):
#         ax.plot(xall[training_size+1:],Rsqr_h_models_2[im],'-',color=plt.get_cmap('tab20')(p*2))
#         ax.plot(xall[training_size+1:],Rsqr_adj_h_models_2[im],'--',color=plt.get_cmap('tab20')(p*2))
#         ax.plot(xall[training_size+1:],Rsqr_pred_h_models_2[im],':',color=plt.get_cmap('tab20')(p*2))
#         ax.text(2008,0.95-p*0.06,'Rsqr forecast = {:03.2f}'.format(Rsqr_f_models_2[im]),color=plt.get_cmap('tab20')(p*2))
#         ax.plot(xall[training_size+1:],np.ones(len(Rsqr_h_models_2[im]))*Rsqr_f_models_2[im],'-',color=plt.get_cmap('tab20')(p*2+1))
#         print(im, x_models_2[im])

#         ax_FUD.plot(xall,yall,'o-',color='k')
#         ax_FUD.plot(xf_models_2[im],yf_models_2[im], 'o:',color=plt.get_cmap('tab20')(p*2))
...
for i in range(len(all_combinations_3)):
    # print(str(i)+'/'+str(len(all_combinations_3)))
    x_model = [ columns[3:][c] for c in all_combinations_3[i] ]
    [model,xall,yall,xf,yf_true,yf,xh_plot,xh,yh,
    mae_h,rmse_h,Rsqr_h,Rsqr_adj_h,std_h,
    mae_f,rmse_f,Rsqr_f,Rsqr_adj_f, std_f] = freezeup_multiple_linear_regression_model(df[['Year','Freeze-up','Freeze-up Anomaly']+x_model],x_model,nyears,training_size,anomaly = anomaly,rolling_training=rolling_training,verbose=False)
    ...
    if (Rsqr_f >= rlim) & (Rsqr_adj_f >= ralim):
        models_3 += [model]
        x_models_3 += [x_model]
        mae_f_models_3 += [mae_f]
        rmse_f_models_3 += [rmse_f]
        Rsqr_f_models_3 += [Rsqr_f]
        Rsqr_adj_f_models_3 += [Rsqr_adj_f]
        std_f_models_3 += [std_f]
        mae_h_models_3 += [mae_h]
        rmse_h_models_3 += [rmse_h]
        Rsqr_h_models_3 += [Rsqr_h]
        Rsqr_adj_h_models_3 += [Rsqr_adj_h]
        std_h_models_3 += [std_h]
        xf_models_3 += [xf]
        yf_models_3 += [yf]
        xh_plot_models_3 += [xh_plot]
        xh_models_3 += [xh]
        yh_models_3 += [yh]

    if (i/(round(len(all_combinations_3)/10)*10))%(0.1) == 0:
        print(str(i)+'/'+str(len(all_combinations_3)))
        np.savez('./MLR_save_v2/models3_it'+str(i)+'_ts'+str(training_size),
                    models_3 = models_3,
                    x_models_3 = x_models_3,
                    mae_f_models_3 = mae_f_models_3,
                    rmse_f_models_3 = rmse_f_models_3,
                    Rsqr_f_models_3 = Rsqr_f_models_3,
                    Rsqr_adj_f_models_3 = Rsqr_adj_f_models_3,
                    std_f_models_3 = std_f_models_3,
                    mae_h_models_3 = mae_h_models_3,
                    rmse_h_models_3 = rmse_h_models_3,
                    Rsqr_h_models_3 =  Rsqr_h_models_3,
                    Rsqr_adj_h_models_3 = Rsqr_adj_h_models_3,
                    std_h_models_3 = std_h_models_3,
                    xf_models_3 = xf_models_3,
                    yf_models_3 = yf_models_3,
                    xh_plot_models_3 = xh_plot_models_3,
                    xh_models_3 = xh_models_3,
                    yh_models_3 = yh_models_3,
                    deseasonalize = deseasonalize ,
                    detrend = detrend,
                    station_labels = station_labels,
                    freezeup_opt = freezeup_opt,
...
yh_true_models_3 = []
for h in range(yh_models_3[0].shape[0]):
    yh_true_models_3 += [avg_freezeup_doy[h:h+training_size]]

# Rsqr_pred_h_models_3 = []
# for im in range(len(x_models_3)):
#     r_tmp = np.zeros(yh_models_3[0].shape[0])*np.nan
#     for h in range(yh_models_3[0].shape[0]):
#         r_tmp[h] = predicted_r2(yh_true_models_3[h],np.squeeze(yh_models_3[im][h,:]),np.squeeze(xh_models_3[im][h,:]))
#     Rsqr_pred_h_models_3 += [r_tmp]



np.savez('./MLR_save_v2/models3_ts'+str(training_size),
            models_3 = models_3,
            x_models_3 = x_models_3,
            mae_f_models_3 = mae_f_models_3,
            rmse_f_models_3 = rmse_f_models_3,
            ...
            Rsqr_h_models_3 =  Rsqr_h_models_3,
            Rsqr_adj_h_models_3 = Rsqr_adj_h_models_3,
            # Rsqr_pred_h_models_3 = Rsqr_pred_h_models_3,
            std_h_models_3 = std_h_models_3,
            xf_models_3 = xf_models_3,
            yf_models_3 = yf_models_3,
            xh_plot_models_3 = xh_plot_models_3,
            xh_models_3 = xh_models_3,
            yh_models_3 = yh_models_3,
            yh_true_models_3 = yh_true_models_3,
            deseasonalize = deseasonalize ,
            detrend = detrend,
            station_labels = station_labels,
            freezeup_opt = freezeup_opt,
...
models_3_Nov1 = []
imodels_3_Nov1 = []
for i in range(len(x_models_3)):
    if (~np.any(['Nov' in x_models_3[i][0],'Nov' in x_models_3[i][1],'Nov' in x_models_3[i][2]])) & (~np.any(['Fall' in x_models_3[i][0],'Fall' in x_models_3[i][1],'Fall' in x_models_3[i][2]])) & (~np.any(['Apr. aFDD' in x_models_3[i][0],'Apr. aFDD' in x_models_3[i][1],'Apr. aFDD' in x_models_3[i][2]])):
        x_tmp = np.squeeze(yall[training_size+1:])
        y_tmp = np.squeeze(yf_models_3[i][:])
        coeff,_ = linear_fit(x_tmp,y_tmp)
        if coeff[0] > 0 :
            models_3_Nov1 += [x_models_3[i]]
            imodels_3_Nov1 += [i]
            print(i,x_models_3[i])

models_3_Dec1 = []
imodels_3_Dec1 = []
for i in range(len(x_models_3)):
    if (~np.any(['Apr. aFDD' in x_models_3[i][0],'Apr. aFDD' in x_models_3[i][1],'Apr. aFDD' in x_models_3[i][2]])):
        x_tmp = np.squeeze(yall[training_size+1:])
        y_tmp = np.squeeze(yf_models_3[i][:])
        coeff,_ = linear_fit(x_tmp,y_tmp)
        if coeff[0] > 0 :
            models_3_Dec1 += [x_models_3[i]]
            imodels_3_Dec1 += [i]
            print(i,x_models_3[i])

np.savez('./MLR_save_v2/models3_Nov1_ts'+str(training_size),
            models_3_Nov1 = models_3_Nov1,
            imodels_3_Nov1 = imodels_3_Nov1,
            rlim = rlim,
            ralim = ralim,)
np.savez('./MLR_save_v2/models3_Dec1_ts'+str(training_size),
               models_3_Dec1 = models_3_Dec1,
               imodels_3_Dec1 = imodels_3_Dec1,
               rlim = rlim,
               ralim = ralim,)
...
for i in range(len(all_combinations_4)):
    # print(str(i)+'/'+str(len(all_combinations_4)))
    x_model = [ columns[3:][c] for c in all_combinations_4[i] ]
    [model,xall,yall,xf,yf_true,yf,xh_plot,xh,yh,
    mae_h,rmse_h,Rsqr_h,Rsqr_adj_h,std_h,
    mae_f,rmse_f,Rsqr_f,Rsqr_adj_f, std_f] = freezeup_multiple_linear_regression_model(df[['Year','Freeze-up','Freeze-up Anomaly']+x_model],x_model,nyears,training_size,anomaly = anomaly,rolling_training=rolling_training,verbose=False)
    ...
    if (Rsqr_f >= rlim) & (Rsqr_adj_f >= ralim):
        models_4 += [model]
        x_models_4 += [x_model]
        mae_f_models_4 += [mae_f]
        rmse_f_models_4 += [rmse_f]
        Rsqr_f_models_4 += [Rsqr_f]
        Rsqr_adj_f_models_4 += [Rsqr_adj_f]
        std_f_models_4 += [std_f]
        mae_h_models_4 += [mae_h]
        rmse_h_models_4 += [rmse_h]
        Rsqr_h_models_4 += [Rsqr_h]
        Rsqr_adj_h_models_4 += [Rsqr_adj_h]
        std_h_models_4 += [std_h]
        xf_models_4 += [xf]
        yf_models_4 += [yf]
        xh_models_4 += [xh]
        xh_plot_models_4 += [xh_plot]
        yh_models_4 += [yh]

    if (i/(round(len(all_combinations_4)/10)*10))%(0.1) == 0:
        print(str(i)+'/'+str(len(all_combinations_4)))
        np.savez('./MLR_save_v2/models4_it'+str(i)+'_ts'+str(training_size),
                    models_4 = models_4,
                    x_models_4 = x_models_4,
                    mae_f_models_4 = mae_f_models_4,
                    rmse_f_models_4 = rmse_f_models_4,
                    Rsqr_f_models_4 = Rsqr_f_models_4,
                    Rsqr_adj_f_models_4 = Rsqr_adj_f_models_4,
                    std_f_models_4 = std_f_models_4,
                    mae_h_models_4 = mae_h_models_4,
                    rmse_h_models_4 = rmse_h_models_4,
                    Rsqr_h_models_4 =  Rsqr_h_models_4,
                    Rsqr_adj_h_models_4 = Rsqr_adj_h_models_4,
                    std_h_models_4 = std_h_models_4,
                    xf_models_4 = xf_models_4,
                    yf_models_4 = yf_models_4,
                    xh_plot_models_4 = xh_plot_models_4,
                    xh_models_4 = xh_models_4,
                    yh_models_4 = yh_models_4,
                    deseasonalize = deseasonalize ,
                    detrend = detrend,
                    station_labels = station_labels,
                    freezeup_opt = freezeup_opt,
...
yh_true_models_4 = []
for h in range(yh_models_4[0].shape[0]):
    yh_true_models_4 += [avg_freezeup_doy[h:h+training_size]]

# Rsqr_pred_h_models_4 = []
# for im in range(len(x_models_4)):
#     r_tmp = np.zeros(yh_models_4[0].shape[0])*np.nan
#     for h in range(yh_models_4[0].shape[0]):
#         r_tmp[h] = predicted_r2(yh_true_models_4[h],np.squeeze(yh_models_4[im][h,:]),np.squeeze(xh_models_4[im][h,:]))
#     Rsqr_pred_h_models_4 += [r_tmp]


np.savez('./MLR_save_v2/models4_ts'+str(training_size),
            models_4 = models_4,
            x_models_4 = x_models_4,
            mae_f_models_4 = mae_f_models_4,
            rmse_f_models_4 = rmse_f_models_4,
            ...
            Rsqr_h_models_4 =  Rsqr_h_models_4,
            Rsqr_adj_h_models_4 = Rsqr_adj_h_models_4,
            # Rsqr_pred_h_models_4 = Rsqr_pred_h_models_4,
            std_h_models_4 = std_h_models_4,
            xf_models_4 = xf_models_4,
            yf_models_4 = yf_models_4,
            xh_models_4 = xh_models_4,
            xh_plot_models_4 = xh_plot_models_4,
            yh_models_4 = yh_models_4,
            yh_true_models_4 = yh_true_models_4,
            deseasonalize = deseasonalize ,
            detrend = detrend,
            station_labels = station_labels,
            freezeup_opt = freezeup_opt,
...
models_4_Nov1 = []
imodels_4_Nov1 = []
for i in range(len(x_models_4)):
    if (~np.any(['Nov' in x_models_4[i][0],'Nov' in x_models_4[i][1],'Nov' in x_models_4[i][2],'Nov' in x_models_4[i][3]])) & (~np.any(['Fall' in x_models_4[i][0],'Fall' in x_models_4[i][1],'Fall' in x_models_4[i][2],'Fall' in x_models_4[i][3]])) & (~np.any(['Apr. aFDD' in x_models_4[i][0],'Apr. aFDD' in x_models_4[i][1],'Apr. aFDD' in x_models_4[i][2],'Apr. aFDD' in x_models_4[i][3]])):
        x_tmp = np.squeeze(yall[training_size+1:])
        y_tmp = np.squeeze(yf_models_4[i][:])
        coeff,_ = linear_fit(x_tmp,y_tmp)
        if coeff[0] > 0 :
            models_4_Nov1 += [x_models_4[i]]
            imodels_4_Nov1 += [i]
            print(i,x_models_4[i])

models_4_Dec1 = []
imodels_4_Dec1 = []
for i in range(len(x_models_4)):
    if (~np.any(['Apr. aFDD' in x_models_4[i][0],'Apr. aFDD' in x_models_4[i][1],'Apr. aFDD' in x_models_4[i][2],'Apr. aFDD' in x_models_4[i][3]])):
        x_tmp = np.squeeze(yall[training_size+1:])
        y_tmp = np.squeeze(yf_models_4[i][:])
        coeff,_ = linear_fit(x_tmp,y_tmp)
        if coeff[0] > 0 :
            models_4_Dec1 += [x_models_4[i]]
            imodels_4_Dec1 += [i]
            print(i,x_models_4[i])

np.savez('./MLR_save_v2/models4_Nov1_ts'+str(training_size),
            models_4_Nov1 = models_4_Nov1,
            imodels_4_Nov1 = imodels_4_Nov1,
            rlim = rlim,
            ralim = ralim,)
np.savez('./MLR_save_v2/models4_Dec1_ts'+str(training_size),
               models_4_Dec1 = models_4_Dec1,
               imodels_4_Dec1 = imodels_4_Dec1,
               rlim = rlim,
               ralim = ralim,)
...
for i in range(len(all_combinations_5)):
    # print(str(i)+'/'+str(len(all_combinations_5)))
    x_model = [ columns[3:][c] for c in all_combinations_5[i] ]
    [model,xall,yall,xf,yf_true,yf,xh_plot,xh,yh,
    mae_h,rmse_h,Rsqr_h,Rsqr_adj_h,std_h,
    mae_f,rmse_f,Rsqr_f,Rsqr_adj_f, std_f] = freezeup_multiple_linear_regression_model(df[['Year','Freeze-up','Freeze-up Anomaly']+x_model],x_model,nyears,training_size,anomaly = anomaly,rolling_training=rolling_training,verbose=False)
    ...
    if (Rsqr_f >= rlim) & (Rsqr_adj_f >= ralim):
        models_5 += [model]
        x_models_5 += [x_model]
        mae_f_models_5 += [mae_f]
        rmse_f_models_5 += [rmse_f]
        Rsqr_f_models_5 += [Rsqr_f]
        Rsqr_adj_f_models_5 += [Rsqr_adj_f]
        std_f_models_5 += [std_f]
        mae_h_models_5 += [mae_h]
        rmse_h_models_5 += [rmse_h]
        Rsqr_h_models_5 += [Rsqr_h]
        Rsqr_adj_h_models_5 += [Rsqr_adj_h]
        std_h_models_5 += [std_h]
        xf_models_5 += [xf]
        yf_models_5 += [yf]
        xh_models_5 += [xh]
        xh_plot_models_5 += [xh_plot]
        yh_models_5 += [yh]

    if (i/(round(len(all_combinations_5)/10)*10))%(0.1) == 0:
        print(str(i)+'/'+str(len(all_combinations_5)))
        np.savez('./MLR_save_v2/models5_it'+str(i)+'_ts'+str(training_size),
                     models_5 = models_5,
                     x_models_5 = x_models_5,
                     mae_f_models_5 = mae_f_models_5,
                     rmse_f_models_5 = rmse_f_models_5,
                     Rsqr_f_models_5 = Rsqr_f_models_5,
                     Rsqr_adj_f_models_5 = Rsqr_adj_f_models_5,
                     std_f_models_5 = std_f_models_5,
                     mae_h_models_5 = mae_h_models_5,
                     rmse_h_models_5 = rmse_h_models_5,
                     Rsqr_h_models_5 =  Rsqr_h_models_5,
                     Rsqr_adj_h_models_5 = Rsqr_adj_h_models_5,
                     std_h_models_5 = std_h_models_5,
                     xf_models_5 = xf_models_5,
                     yf_models_5 = yf_models_5,
                     xh_models_5 = xh_models_5,
                     xh_plot_models_5 = xh_plot_models_5,
                     yh_models_5 = yh_models_5,
                     deseasonalize = deseasonalize ,
                     detrend = detrend,
                     station_labels = station_labels,
                     freezeup_opt = freezeup_opt,
...
yh_true_models_5 = []
for h in range(yh_models_5[0].shape[0]):
    yh_true_models_5 += [avg_freezeup_doy[h:h+training_size]]

# Rsqr_pred_h_models_5 = []
# for im in range(len(x_models_5)):
#     r_tmp = np.zeros(yh_models_5[0].shape[0])*np.nan
#     for h in range(yh_models_5[0].shape[0]):
#         r_tmp[h] = predicted_r2(yh_true_models_5[h],np.squeeze(yh_models_5[im][h,:]),np.squeeze(xh_models_5[im][h,:]))
#     Rsqr_pred_h_models_5 += [r_tmp]


np.savez('./MLR_save_v2/models5_ts'+str(training_size),
            models_5 = models_5,
            x_models_5 = x_models_5,
            mae_f_models_5 = mae_f_models_5,
            rmse_f_models_5 = rmse_f_models_5,
            ...
            Rsqr_h_models_5 =  Rsqr_h_models_5,
            Rsqr_adj_h_models_5 = Rsqr_adj_h_models_5,
            # Rsqr_pred_h_models_5 = Rsqr_pred_h_models_5,
            std_h_models_5 = std_h_models_5,
            xf_models_5 = xf_models_5,
            yf_models_5 = yf_models_5,
            xh_models_5 = xh_models_5,
            xh_plot_models_5 = xh_plot_models_5,
            yh_models_5 = yh_models_5,
            yh_true_models_5 = yh_true_models_5,
            deseasonalize = deseasonalize ,
            detrend = detrend,
            station_labels = station_labels,
            freezeup_opt = freezeup_opt,
...
models_5_Nov1 = []
imodels_5_Nov1 = []
for i in range(len(x_models_5)):
    if (~np.any(['Nov' in x_models_5[i][0],'Nov' in x_models_5[i][1],'Nov' in x_models_5[i][2],'Nov' in x_models_5[i][3],'Nov' in x_models_5[i][4]])) & (~np.any(['Fall' in x_models_5[i][0],'Fall' in x_models_5[i][1],'Fall' in x_models_5[i][2],'Fall' in x_models_5[i][3],'Fall' in x_models_5[i][4]])) & (~np.any(['Apr. aFDD' in x_models_5[i][0],'Apr. aFDD' in x_models_5[i][1],'Apr. aFDD' in x_models_5[i][2],'Apr. aFDD' in x_models_5[i][3],'Apr. aFDD' in x_models_5[i][4]])):
        x_tmp = np.squeeze(yall[training_size+1:])
        y_tmp = np.squeeze(yf_models_5[i][:])
        coeff,_ = linear_fit(x_tmp,y_tmp)
        if coeff[0] > 0 :
            models_5_Nov1 += [x_models_5[i]]
            imodels_5_Nov1 += [i]
            print(i,x_models_5[i])

models_5_Dec1 = []
imodels_5_Dec1 = []
for i in range(len(x_models_5)):
    if (~np.any(['Apr. aFDD' in x_models_5[i][0],'Apr. aFDD' in x_models_5[i][1],'Apr. aFDD' in x_models_5[i][2],'Apr. aFDD' in x_models_5[i][3],'Apr. aFDD' in x_models_5[i][4]])):
        x_tmp = np.squeeze(yall[training_size+1:])
        y_tmp = np.squeeze(yf_models_5[i][:])
        coeff,_ = linear_fit(x_tmp,y_tmp)
        if coeff[0] > 0 :
            models_5_Dec1 += [x_models_5[i]]
            imodels_5_Dec1 += [i]
            print(i,x_models_5[i])

np.savez('./MLR_save_v2/models5_Nov1_ts'+str(training_size),
            models_5_Nov1 = models_5_Nov1,
            imodels_5_Nov1 = imodels_5_Nov1,
            rlim = rlim,
            ralim = ralim,)
np.savez('./MLR_save_v2/models5_Dec1_ts'+str(training_size),
               models_5_Dec1 = models_5_Dec1,
               imodels_5_Dec1 = imodels_5_Dec1,
               rlim = rlim,
               ralim = ralim,)
