...
np.savez('./ML_pred_'+model_name+'_horizon_'+str(label_width)+'_input_'+str(input_width)+'_nepochs_'+str(epoch),
...
# _, clim_train = sliding_window_samples(train_dataset,input_width,label_width,shift,nslide,input_col,clim_col)
# _, clim_valid = sliding_window_samples(valid_dataset,input_width,label_width,shift,nslide,input_col,clim_col)
# _, clim_test = sliding_window_samples(test_dataset,input_width,label_width,shift,nslide,input_col,clim_col)
