...
for nb_layers in nb_layers_list:
    for input_window in input_window_list:
        ...
        test_yr_start = 2017  # !!!!!!!!!! TEST TO COMPLETE YEARS MISSING !!!!!!!!!!
        ...
        nsplits = test_yr_start-valid_yr_start #!!!!!!!!!! TEST TO COMPLETE YEARS MISSING !!!!!!!!!!
        ...
        for i_split in range(nsplits):
            ...
            np.savez('./MLP_'+valid_scheme+'valid/'+use_softplus*'softplus/'+model_name+'_valid'+ str(valid_yr_start+i_split) +'_horizon'+str(label_width)+'_context'+str(input_width)+'_nlayers'+str(nb_layers)+'_nneurons'+str(nb_neurons)+'_nepochs'+str(epoch)+'_'+norm_type+'_'+suffix,
