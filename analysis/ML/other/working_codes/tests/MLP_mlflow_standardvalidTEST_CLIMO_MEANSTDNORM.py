...
evaluate_ML_pred(targets,predictions,yr_input_train,time_target_train,clim_target_train,train_range_tar,train_offset_tar,plot_pred_ts = True)
...
# np.savez('./MLP_standardvalid/'+model_name+'_horizon'+str(label_width)+'_context'+str(input_width)+'_nlayers'+str(nb_layers)+'_nepochs'+str(epoch)+'_'+suffix,
np.savez('./MLP_standardvalid/TEST_CLIMO_MEANSTDNORM',
