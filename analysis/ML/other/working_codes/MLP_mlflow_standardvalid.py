...
for nb_layers in nb_layers_list:
    for input_window in input_window_list:
        ...
        np.savez('./MLP_standardvalid/'+use_softplus*'softplus/'+model_name+'_horizon'+str(label_width)+'_context'+str(input_width)+'_nlayers'+str(nb_layers)+'_nneurons'+str(nb_neurons)+'_nepochs'+str(epoch)+'_'+norm_type+'_'+suffix,
