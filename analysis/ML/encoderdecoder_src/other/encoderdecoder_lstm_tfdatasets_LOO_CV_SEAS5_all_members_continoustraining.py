...
suffix = '_reducelrexp_0_05_lr0_004_PFE_withsnow'
...
# suffix = '_reducelrexp_0_02_lr0_00004_RWE_allmembers_continuoustraining_withsnow'
# suffix = '_reducelrexp_0_02_lr0_00004_PFE_withsnow'
...
#%%
        ...
        # for iyr_test,yr_test in enumerate(test_years[10:12]):
            ...
            if nfolds > 0:
                for ifold,[train_index, valid_index] in enumerate(kf.split(ind_kfold)):
                    ...
                    _,y_pred_valid,_,
                    _,y_valid,_,
                    _,y_clim_valid,_] = execute_fold_tpf_allmembers_continuoustraining(df_t_train_fold, df_t_valid_fold, df_t_test_fold,
            ...
            y_train,_,y_test,
            y_clim_train,_,y_clim_test] = execute_fold_tpf_allmembers_continuoustraining(df_t_train, df_t_valid, df_t_test,
    ...
    if valid_scheme == 'standard':
        ...
        y_clim_train,y_clim_valid,y_clim_test] = execute_fold_tpf_allmembers_continuoustraining(df_t_train, df_t_valid, df_t_test,
                                                                                              df_p_train, df_p_valid, df_p_test,
                                                                                              df_f_train, df_f_valid, df_f_test,
